...
// Create project
router.post("/", authenticate, validate(createProjectSchema), asyncHandler(async (req: Request, res: Response) => {
...
router.get("/", authenticate, asyncHandler(async (req: Request, res: Response) => {
  ...
  const projectsWithRole = projects.map((project: any) => {
    ...
    return {
      ...project.toObject(),
      userRole: isOwner ? ProjectRole.OWNER : member?.role || ProjectRole.MEMBER,
    };
  });
...
router.get("/:projectId/stats", authenticate, checkProjectMembership, requirePermission(ProjectPermission.VIEW_PROJECT), asyncHandler(async (req: Request, res: Response) => {
...
router.get("/dashboard/overview", authenticate, asyncHandler(async (req: Request, res: Response) => {
...
router.post("/:projectId/members", authenticate, checkProjectMembership, requirePermission(ProjectPermission.MANAGE_MEMBERS), validate(addMemberSchema), asyncHandler(async (req: Request, res: Response) => {
  const { projectId } = req.params;
...
// Update member role
router.patch("/:projectId/members/:userId/role", authenticate, checkProjectMembership, requirePermission(ProjectPermission.MANAGE_ROLES), asyncHandler(async (req: Request, res: Response) => {
...
router.delete("/:projectId/members/:userId", authenticate, checkProjectMembership, requirePermission(ProjectPermission.MANAGE_MEMBERS), asyncHandler(async (req: Request, res: Response) => {
  const { projectId, userId } = req.params;
...
router.patch("/:projectId/transfer", authenticate, validate(transferOwnershipSchema), asyncHandler(async (req: Request, res: Response) => {
  const { projectId } = req.params;
